...
var createReactClass = __webpack_require__(81);
...
module.exports = {
    createClass: function createClass(chartType, methodNames, dataKey) {
        ...
        classData.initializeChart = function (nextProps) {
            var Chart = __webpack_require__(83);
...
exports.fetchNews = exports.PAGE_CHANNEL = exports.PAGE_CHANGE = exports.ERR_FETCH = exports.FETCH_NEWS_ERROR = exports.FETCH_NEWS_SUCCESS = exports.FETCH_NEWS_REQUEST = undefined;
exports.changePage = changePage;
exports.setActiveNew = setActiveNew;

var _index = __webpack_require__(33);

var FETCH_NEWS_REQUEST = exports.FETCH_NEWS_REQUEST = 'FETCH_NEWS_REQUEST';
var FETCH_NEWS_SUCCESS = exports.FETCH_NEWS_SUCCESS = 'FETCH_NEWS_SUCCESS';
var FETCH_NEWS_ERROR = exports.FETCH_NEWS_ERROR = 'FETCH_NEWS_ERROR';
...
var fetchNews = exports.fetchNews = function fetchNews(link) {
    return function (dispatch) {
        return dispatch({
            CALL_API: {
                types: [FETCH_NEWS_REQUEST, FETCH_NEWS_SUCCESS, FETCH_NEWS_ERROR],
                endpoint: function endpoint() {
                    return (0, _index.get)('https://query.yahooapis.com/v1/public/yql?q=select%20title%20from%20rss%20where%20url%3D%22' + link + '%22&format=json&diagnostics=true', {});
                }
            }
        });
    };
...
var _urlResolver = __webpack_require__(72);
...
var get = function get(url) {
    ...
    return fetch((0, _urlResolver2.default)(url, extraParams));
};

var POST_CONFIG = { method: 'POST', headers: { 'Content-Type': _const.CONTENT_TYPE_JSON } };
var post = function post(url, body) {
    var extraParams = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    return fetch((0, _urlResolver2.default)(url, extraParams), _extends({}, POST_CONFIG, { body: JSON.stringify(body) }));
};

var PUT_CONFIG = { method: 'PUT', headers: { 'Content-Type': _const.CONTENT_TYPE_JSON } };
var put = function put(url, body) {
    var extraParams = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    return fetch((0, _urlResolver2.default)(url, extraParams), _extends({}, PUT_CONFIG, { body: JSON.stringify(body) }));
};

var remove = function remove(url) {
    var extraParams = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return fetch((0, _urlResolver2.default)(url, extraParams), { method: 'DELETE' });
};
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(5);var warning=__webpack_require__(7);var ExecutionEnvironment=__webpack_require__(16);var _assign=__webpack_require__(4);var emptyFunction=__webpack_require__(2);var EventListener=__webpack_require__(17);var getActiveElement=__webpack_require__(18);var shallowEqual=__webpack_require__(19);var containsNode=__webpack_require__(20);var focusNode=__webpack_require__(21);var emptyObject=__webpack_require__(6);var checkPropTypes=__webpack_require__(8);var hyphenateStyleName=__webpack_require__(41);var camelizeStyleName=__webpack_require__(43);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var _Symbol2 = __webpack_require__(26);
...
exports.default = function (url, extraParams) {
    var params = _extends({}, extraParams);
    return url + '?' + Object.entries(params).map(function (_ref) {
...
var _channels = __webpack_require__(77);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        key: 'onPagesChange',
        value: function onPagesChange() {
            var _this2 = this;

            var pages = [];
            for (var i = 1; i <= Math.ceil(this.props.news.newsItems.length / 3); i++) {
                pages.push(i);
            }
            ...
            return pages.map(function (number) {
                return _react2.default.createElement(
                    'span',
                    { className: _this2.props.news.currentPage == number ? 'activePage page' : 'page',
                        onClick: _this2.onPageClick.bind(_this2), key: number, id: number },
                    number
                );
            });
        }
        ...
        value: function render() {
            ...
            var indexOfLastNewsItem = this.props.news.currentPage * 3;
            var indexOfFirstNewsItem = indexOfLastNewsItem - 3;
            var currentNews = this.props.news.newsItems.slice(indexOfFirstNewsItem, indexOfLastNewsItem);
            var renderNews = currentNews.map(function (newsItem, index) {
                return _react2.default.createElement(
                    'li',
                    { onClick: _this3.onClickTitle(newsItem), className: 'channel-item', key: index },
                    newsItem.title
                );
            });
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'column-rss' },
                    _react2.default.createElement(
                        'label',
                        null,
                        'link rss'
                    ),
                    _react2.default.createElement('input', { onChange: this.onLinkChange.bind(this), value: this.state.link, className: 'linkInput' }),
                    _react2.default.createElement(
                        'button',
                        { className: 'fetchButton', onClick: this.clickHandler.bind(this) },
                        'click fetch'
                    ),
...
}, { fetchNews: _actions.fetchNews, changePage: _actions.changePage, setActiveNew: _actions.setActiveNew })(App);
...
var ListItems = function (_Component) {
    ...
    function ListItems() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ListItems.__proto__ || Object.getPrototypeOf(ListItems)).call.apply(_ref, [this].concat(args))), _this), _this.handleOnClick = function (path) {
            return function () {
                _this.props.fetchNews(path);
            };
        }, _this.renderMenuItem = function (item) {
            var _this$props$location = _this.props.location;
            _this$props$location = _this$props$location === undefined ? {} : _this$props$location;
            ...
            return _react2.default.createElement(
                'li',
                { key: path, onClick: _this.handleOnClick(path),
...
exports.default = (0, _reactRedux.connect)(null, { fetchNews: _index.fetchNews })(ListItems);
...
var PieChart = __webpack_require__(79).Pie;
...
var MyComponent = function (_React$Component) {
    ...
    _createClass(MyComponent, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(PieChart, { data: this.state.chartData, redraw: true });
        }
    }]);
...
var Show = function (_Component2) {
    ...
    function Show() {
        ...
        return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_ref = Show.__proto__ || Object.getPrototypeOf(Show)).call.apply(_ref, [this].concat(args))), _this3), _this3.state = {
            showModal: false
        }, _this3.handleShow = function () {
            return function () {
    ...
    _createClass(Show, [{
        ...
        value: function render() {
            var modal = this.state.showModal ? _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'main__content--modal-main' },
                            _react2.default.createElement(
                                'p',
                                { className: 'main__content--modal-content' },
                                'Show Statistic'
                            ),
                            _react2.default.createElement(
                                'a',
                                { className: 'main__content--modal-close', href: '#', onClick: this.handleHide() },
                                'x'
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { className: 'main__content--modal-cancel', type: 'cancel',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { className: 'button-plus', onClick: this.handleShow() },
                    'Statistic'
                ),
                modal
            );
...
module.exports = {
  Bar: __webpack_require__(80),
  Doughnut: __webpack_require__(85),
  Line: __webpack_require__(86),
  Pie: __webpack_require__(87),
  PolarArea: __webpack_require__(88),
  Radar: __webpack_require__(89),
...
(function () {
	...
	var each = helpers.each = function (loopable, callback, self) {
	    ...
	    amd = helpers.amd = "function" === 'function' && __webpack_require__(84),
...
var _news_reducer = __webpack_require__(91);

var _news_reducer2 = _interopRequireDefault(_news_reducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({
	news: _news_reducer2.default
});
...
exports.default = function () {
    ...
    console.log(action);
    switch (action.type) {
        case _actions.FETCH_NEWS_REQUEST:
            return _extends({}, state);
        case _actions.FETCH_NEWS_SUCCESS:
            return { newsItems: action.response.query.results.item, err: '', currentPage: 1 };
        case _actions.FETCH_NEWS_ERROR:
...
var defaultState = { err: '', newsItems: [], currentPage: 1, activeNew: null };
;
